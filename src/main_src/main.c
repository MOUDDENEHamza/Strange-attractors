...
int main(int argc, char *argv[]) {
    ...
    p_file(file_name, point_file, flag);//name point_file as (name of system)_coordinates.dat
    v_file(file_name, vector_file, flag);//name vector_file as (name of system)_vectors.dat
    file(p->position, p->speed_t, &i, flag, point_file, vector_file);//write the data into the point_file and vector_file
